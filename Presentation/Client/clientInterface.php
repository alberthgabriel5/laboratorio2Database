...
buttonImageOnly: true
    ...
    <body>
        ...
        <?php
        $result1 = $clientBusiness->getClient();
        foreach ($result1 as $tem) {
            echo'<form id="clients" method="POST" action="../../Business/Client/clientUpdateDeleteAction.php">                                
                    ...
                    <input type="text" id="nameClient" name="nameClient" size="10" maxlength="15" value= ' .str_replace('+','&nbsp;', $tem->nameClient) . '> 
                    ...
                    <input type="date" id="bornClient" name="bornClient" size="10" maxlength="15"  value= ' . $tem->bornClient . '>
                    ...
                    <input type="text" id="cantonClient" name="cantonClient" value= ' .str_replace('+','&nbsp;', $tem->cantonClient ). '> 
                    <input type="text" id="districtClient" name="districtClient" value= ' .str_replace('+','&nbsp;', $tem->districtClient) . '> 
                    <input type="text" id="addressClient1" name="addressClient1" value= ' .str_replace('+','&nbsp;', $tem->addressClient1 ). '>                        
                    <input type="text" id="addressClient2" name="addressClient2" value= '. str_replace('+','&nbsp;', $tem->addressClient2) . '>                        
                    <input type="submit" id="update" name="update" value="Actualizar" />
                    <input type="submit" id="delete" name="delete" value="Desactivar" />
                    <label id="txtMessage' . $tem->idClient . '"></label>                    
            </form>';
        }
        ?>
        ...
        <form name="frmCombos" method="post" action="../../Business/Client/clientInsertAction.php">
...
function seeFormulary() {

    echo'<form name="frmCombos" method="post" "../../Business/Client/clientInsertAction.php>
                    <h1>Registro de Nuevo Usuario</h1>
            <h3>Usuario</h3>
            <input type="email" id="txtEmailClient" name="txtEmailClient" 
                   data-validation="custom" data-validation-regexp="^([a-zA-Z]+)$"
    ...
    '<input type="text" id="txtTelClient" name="txtTelClient" placeholder="Telefono"> 
            <h3>Direcci&#243;n</h3> ' .
    fullProvince() . fullCanton() . fullDistrict() .
    '<input type="text" id="txtAddressClient1" name="txtAddressClient1" placeholder="Barrio"> 
            <input type="text" id="txtAddressClient2" name="txtAddressClient2" placeholder="Localizacion"> 
...
function fullProvince() {
    ...
    $consulta = $db->consulta("SELECT idProvince, nameProvince FROM tbprovince WHERE idProvince > 0 ORDER BY idProvince ASC;");
    $combo = "";
    $i = 0;
    if ($db->num_rows($consulta) > 0) {
        $combo = '<select name="cmbProvince" onchange="cargarMunicipios(value);">';
